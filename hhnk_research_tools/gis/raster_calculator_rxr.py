...
class RasterCalculatorRxr:
    ...
    For each block the custom_run_window_function will be run. This always takes the
    dataarrays as input and returns is too. For example:

    def run_dem_window(da_out):
